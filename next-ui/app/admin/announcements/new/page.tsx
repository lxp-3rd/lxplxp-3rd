      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between mb-xl gap-md">
        ...
        <div className="flex items-center gap-md">
          ...
          <button
            ...
            className="px-lg py-sm font-label-md bg-primary-container text-white rounded-lg shadow-sm hover:shadow-md transition-all active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
          >
