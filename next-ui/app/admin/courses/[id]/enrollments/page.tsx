            ...
            <div className="flex-grow w-full max-w-[1280px] mx-auto px-margin-mobile md:px-margin-desktop py-xl">
                ...
                <div className="mb-lg">
                    <Link href="/admin/courses"
                          className="group flex items-center gap-xs font-label-md text-label-md text-on-surface-variant hover:text-primary transition-colors"><span
                        className="material-symbols-outlined">arrow_back</span>
                        강좌 관리로 돌아가기</Link>
                </div>

                <section
                    className="bg-surface-container-lowest border border-surface-variant rounded-xl p-lg md:p-xl shadow-sm mb-xl flex flex-col md:flex-row gap-lg items-start md:items-center">
                    ...
                    <div className="flex-grow">
                        <h1 className="font-headline-md text-headline-md text-on-surface mb-sm">데이터 중심의 UI/UX 디자인 실무
                            입문</h1>
                        <div className="flex flex-wrap items-center gap-md text-on-surface-variant">
                            ...
                            <div className="flex items-center gap-xs">
                                ...
                                <span className="font-body-md text-body-md">총 <span
                                    className="font-bold text-primary">1,240</span>명 수강 중</span>
                            </div>
                        </div>
                    </div>
                    <div className="flex flex-col gap-sm w-full md:w-auto">
                        <span
                            className="bg-secondary-container text-on-secondary-container px-md py-xs rounded-full font-label-md text-label-md text-center">Active Course</span>
                    </div>
                </section>
                ...
                <div
                    ...
                    <div
                        className="px-lg py-md border-b border-surface-variant bg-surface-container-low flex justify-between items-center">
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full text-left border-collapse">
                            ...
                            <tr className="bg-surface-container-low border-b border-surface-variant">
                                ...
                                <th className="px-lg py-md font-label-md text-label-md text-on-surface-variant">Enrollment
                                    Date
                                </th>
                            ...
                            <tr className="hover:bg-surface-bright transition-colors group">
                                ...
                                <td className="px-lg py-md">
                                    <div className="flex items-center gap-sm">
                                        ...
                                        <span
                                            className="font-label-sm text-label-sm text-on-surface font-bold">85%</span>
                                    </div>
                                </td>
                                <td className="px-lg py-md text-right">
                                    <button
                                        className="px-md py-1.5 rounded border border-error text-error font-label-md text-label-md hover:bg-error-container/10 transition-all active:scale-95">수강
                                        취소
                                    </button>
                                </td>
                            </tr>
                            ...
                            <tr className="hover:bg-surface-bright transition-colors group">
                                ...
                                <td className="px-lg py-md">
                                    <div className="flex items-center gap-sm">
                                        ...
                                        <span
                                            className="font-label-sm text-label-sm text-on-surface font-bold">42%</span>
                                    </div>
                                </td>
                                <td className="px-lg py-md text-right">
                                    <button
                            ...
                            <tr className="hover:bg-surface-bright transition-colors group">
                                ...
                                <td className="px-lg py-md">
                                    <div className="flex items-center gap-sm">
                                        ...
                                        <span
                                            className="font-label-sm text-label-sm text-on-surface font-bold">100%</span>
                                    </div>
                                </td>
                                <td className="px-lg py-md text-right">
                                    <button
                            ...
                            <tr className="hover:bg-surface-bright transition-colors group">
                                ...
                                <td className="px-lg py-md">
                                    <div className="flex items-center gap-sm">
                                        ...
                                        <span
                                            className="font-label-sm text-label-sm text-on-surface font-bold">15%</span>
                                    </div>
                                </td>
                                <td className="px-lg py-md text-right">
                                    <button
                            ...
                            <tr className="hover:bg-surface-bright transition-colors group">
                                ...
                                <td className="px-lg py-md">
                                    <div className="flex items-center gap-sm">
                                        ...
                                        <span
                                            className="font-label-sm text-label-sm text-on-surface font-bold">60%</span>
                                    </div>
                                </td>
                                <td className="px-lg py-md text-right">
                                    <button
                            ...
                            <tr className="hover:bg-surface-bright transition-colors group">
                                ...
                                <td className="px-lg py-md">
                                    <div className="flex items-center gap-sm">
                                        ...
                                        <span
                                            className="font-label-sm text-label-sm text-on-surface font-bold">0%</span>
                                    </div>
                                </td>
                                <td className="px-lg py-md text-right">
                                    <button
                    ...
                    <div
                        className="px-lg py-md bg-surface-container-low border-t border-surface-variant flex justify-between items-center">
                        <div className="flex items-center gap-sm">
                            <button
                                className="p-xs rounded hover:bg-surface-container text-on-surface-variant transition-colors disabled:opacity-30"
                                disabled>
                                <span className="material-symbols-outlined">chevron_left</span>
                            </button>
                            <span className="font-label-md text-label-md text-on-surface font-bold">1</span>
                            <button
                                className="p-xs rounded hover:bg-surface-container text-on-surface-variant transition-colors">
                ...
                <div
                    className="hidden mt-xl flex flex-col items-center justify-center py-20 px-lg bg-surface-container-lowest border border-dashed border-outline-variant rounded-xl text-center"
                    id="empty-state">
                    ...
                    <p className="font-headline-md text-headline-md text-on-surface-variant mb-xs">현재 수강 중인 회원이
                        없습니다.</p>
