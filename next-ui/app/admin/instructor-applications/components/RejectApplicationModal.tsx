...
export function RejectApplicationModal({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/40 flex items-center justify-center px-gutter">
      <div className="bg-surface-container-lowest rounded-xl border border-outline-variant p-lg w-full max-w-[480px] shadow-xl">
        <h2 className="text-title-lg font-title-lg text-on-surface mb-sm">강사 신청 반려</h2>
        ...
        <div className="flex justify-end gap-sm mt-lg">
          ...
          <button
            type="button"
            onClick={() => onSubmit(target.id, reason)}
            className="px-lg py-sm bg-error text-on-error rounded-lg hover:brightness-110"
          >
            반려
          </button>
        </div>
